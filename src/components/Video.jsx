...
const Video = ({ video }) => {
    return (
        <div>
            <div className='flex justify-start items-center m-2 p-2 gap-2 max-w-full bg-[#f7efefa3] border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 '>
